...
3)Declare a variable named is_student and assign it a boolean value of True.
   Print the value of is_student.
4)Create a list named gadgets containing the following elements: "laptop", "phone", "earbuds". 
   Print the list.
5)Declare a tuple named colors containing the following elements: "black", "blue", "red". 
   Print the tuple.
6)Create a dictionary named person with the following key-value pairs: "name": "Scholar", "age": 20, "city": "Bulawayo".
